...
M2REQUESTS_SSL_MODULE_PATH = os.getenv(
    "M2REQUESTS_SSL_MODULE_PATH", "/usr/lib/x86_64-linux-gnu/opensc-pkcs11.so"
)
...
M2REQUESTS_SSL_CERT_PATH = os.getenv("M2REQUESTS_SSL_CERT_PATH", None)
M2REQUESTS_SSL_KEY_PATH = os.getenv("M2REQUESTS_SSL_KEY_PATH", None)
